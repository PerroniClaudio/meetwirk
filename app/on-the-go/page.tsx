  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <div className="container mx-auto px-8 py-32 flex flex-col gap-4 text-center text-gray-800 text-xl lg:text-3xl">
        <p className="">
          Il lavoro si svolge ovunque. Sul treno. Mentre si prende un caffè. Tra
          una riunione e l’altra. Non sorprende che quasi il 50% delle chiamate
          di lavoro avvenga su dispositivi mobili.
        </p>
        <p>
        ...
        <p>
          ...
          qualità audio, per rendervi ancora più produttivi e poter dare il
          meglio di voi ovunque il lavoro vi porti.
        </p>
      </div>
