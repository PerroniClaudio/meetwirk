      ...
      <section className="flex flex-col gap-4 bg-torch-500">
        <ImageComponent imageUrl="/images/landing/imprese1.webp">
          <div className="flex flex-col gap-4 mx-auto items-center justify-center py-16 px-8 lg:px-32">
            ...
            <p className="text-2xl text-center">
              Con i nostri sistemi potrai mostrargli anche da remoto i tuoi
              migliori prodotti.
            </p>
          </div>
        </ImageComponent>

        <ImageComponent imageUrl="/images/landing/imprese2.webp" invert={true}>
          <div className="flex flex-col gap-4 mx-auto items-center justify-center py-16 px-8 lg:px-32">
            <h1 className="text-4xl font-bold text-torch-500 text-center">
              I MIGLIORI STRUMENTI DI COLLABORATION A TUA DISPOSIZIONE
            </h1>
            <p className="text-2xl text-center">
              Siamo partner Microsoft e grazie al nostro team di tecnici ti
              garantiamo un’integrazione perfetta con la piattaforma Teams e i
              servizi a tua scelta.
            </p>
          </div>
        </ImageComponent>
      </section>
