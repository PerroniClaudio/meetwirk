      ...
      <section className="flex flex-col gap-4 bg-torch-500">
        <ImageComponent imageUrl="/images/landing/remotework1.webp">
          <div className="flex flex-col gap-4 mx-auto items-center justify-center py-16 px-8 lg:px-32">
            <h1 className="text-4xl font-bold text-torch-500 text-center"></h1>
        ...
        <ImageComponent
          ...
          <div className="flex flex-col gap-4 mx-auto items-center justify-center py-16 px-8 lg:px-32">
            ...
            <p className="text-2xl text-center">
              Le nostre soluzioni audio e video, assieme allo sfondo virtuale
              della vostra app di videoconferenza, bloccano le distrazioni ,
              riducono il rumore al minimo e ottimizzano la scarsa
              illuminazione.
            </p>
            <p className="text-2xl text-center">
              Finalmente potete contare sul fatto che le vostre chiamate
              potranno essere ascoltate chiaramente e rimanere comunque private.
            </p>
          </div>
        </ImageComponent>
      </section>
