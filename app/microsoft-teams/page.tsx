...
function MicrosoftTeamsPage({}: Props) {
  return (
    <main className="flex min-h-screen flex-col">
      <section
        className="w-screen min-h-[45vh] bg-center bg-cover bg-no-repeat "
        style={{ backgroundImage: "url(/images/landing/landing10.webp)" }}
      >
      ...
      <div  className="bg-top bg-cover bg-no-repeat" style={{ backgroundImage: "url(/images/onde-bianche.webp)" }}>
        ...
        <div className="container mx-auto px-8 py-32 flex flex-col gap-4 text-center text-gray-800 text-xl lg:text-3xl">
          <p className="">
            Grazie alla nostra partnership con Microsoft possiamo offrirti:
          </p>
        </div>
        ...
        <section className="container mx-auto grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4 mb-16">
          <div className="flex flex-col items-center gap-4">
            <div
              ...
              style={{
                backgroundImage: "url(/images/landing/microsoftteams1.webp)",
              }}
            ></div>
            <p className="font-semibold text-center">
              Gestione e Amministrazione Tenant 365.
            </p>
          ...
          <div className="flex flex-col items-center gap-4">
            <div
              className="rounded-full h-64 w-64  bg-center bg-cover bg-no-repeat "
              style={{
                backgroundImage: "url(/images/landing/microsoftteams2.webp)",
              }}
            ></div>
            <p className="font-semibold text-center">Licenze Office 365.</p>
            {/* <div className="flex flex-col gap-2">
              <p>
          ...
          <div className="flex flex-col items-center gap-4">
            <div
              className="rounded-full h-64 w-64  bg-center bg-cover bg-no-repeat "
              style={{
                backgroundImage: "url(/images/landing/microsoftteams3.webp)",
              }}
            ></div>
            <p className="font-semibold text-center">Integrazione Teams con i flussi aziendali.</p>
            {/* <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col items-center gap-4">
            <div
              className="rounded-full h-64 w-64  bg-center bg-cover bg-no-repeat "
              style={{
                backgroundImage: "url(/images/landing/microsoftteams4.webp)",
              }}
            ></div>
            <p className="font-semibold text-center">Integrazione Teams con centralino VoIP.</p>
            {/* <div className="flex flex-col gap-2">
