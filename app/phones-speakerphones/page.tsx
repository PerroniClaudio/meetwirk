    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="container mx-auto px-8 py-32 flex flex-col gap-4 text-center text-gray-800 text-xl lg:text-3xl">
        ...
        <p>
          ...
          <span className="text-torch-500">innovative</span>, design ergonomici
          e semplicità.​
        </p>
      </div>
      ...
      <section className="flex flex-col gap-4 bg-torch-500">
        ...
        <ImageComponent
          ...
          <div className="flex flex-col gap-4 mx-auto items-center justify-center py-16 px-8 lg:px-32">
            ...
            <p className="text-2xl text-center">
              L’esperienza con Microsoft è familiare e facile da usare. Non
              perderai tempo ad imparare difficili passaggi nulla ti distrae
              dalla gestione dei tuoi business​
            </p>
          </div>
        </ImageComponent>
