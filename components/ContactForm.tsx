    ...
    <section className="w-full bg-gradient-to-b from-torch-800 to-torch-500 p-8 lg:p-16">
      <div className="container mx-auto px-4 flex flex-col gap-4 items-center">
        ...
        <h3 className="text-xl font-semibold text-center">
          Compila il nostro form di contatto per maggiori informazioni.
        </h3>
        <Dialog>
          <DialogTrigger className="bg-neutral-800 text-gray-50 px-8 py-4 rounded-full shadow-md hover:bg-neutral-900 transition-colors duration-300 text-4xl">
            Contattaci
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
